...
public class XpathLocators {
	...
	public static void main(String[] args) throws InterruptedException 
	{
	  ...
	  public static void action(String name,WebDriver driver) throws InterruptedException
	  {
        ...
        System.out.println(driver.findElement(By.xpath("//div[@class='forgot-pwd-btn-conainer']/button[@class='go-to-login-btn']")).getText());      
        System.out.println(driver.findElement(By.xpath("//div/button[2]")).getText());
        driver.findElement(By.xpath("//div/button[2]")).click();
        System.out.println(driver.findElement(By.xpath("//p[contains(text(),'rahulshettyacademy')]")).getText());
        String pwdText=driver.findElement(By.xpath("//p[contains(text(),'rahulshettyacademy')]")).getText();
		...
		System.out.println(driver.findElement(By.xpath("//div/p/parent::div")).getText());
